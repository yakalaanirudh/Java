...
public class Serialization12
{
    public static void main(String[] args) throws Exception
    {
        ...
        dos.writeInt(list.length);      //We are writing how many floats are there in the file
        for(float f:list)
        {
            dos.writeFloat(f);
        }
        ...
        int length=dis.readInt();       //We are reading how many floats are there in the file
        float data;
